abstract class constant{
  ...
  static const List<int> verses =[7,286,200,176,120,165,206,75,129,109,123,111,43,52,99,128,111,110,98,135,112,78,118,64,77,227,93,88,
  ...
  static  List<String> AhadethList = List.generate(50, (index) => "الحديث رقم ${index + 1}");

  static const String hadethFilePath = "assets/files/hadith/ahadeth.txt";
}